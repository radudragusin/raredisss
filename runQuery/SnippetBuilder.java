...
public class SnippetBuilder {
  ...
  public static ArrayList harvestNodes( QueryAnnotation annotation ) throws Exception {
  ...
  public static ArrayList getMatches( QueryAnnotation annotation, int document ) throws Exception {
  ...
  public static String buildSnippet( QueryAnnotation annotation,
                                     ...
                                     int windowSize,
                                     int smallContext,
                                     int largeContext ) throws Exception
  {
